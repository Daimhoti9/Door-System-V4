...
import LabelWithRangeForm1 from './LabelWithRangeForm1';
    ...
    return (
        <div className='col-11' >
            ...
            <div>
                <div className='mt-2'>
                    <b><h5>Door</h5></b>
                    <LabelWithRangeForm1 label="Liggers" number={doorSpecs.numberOfHBars}   setNumber={setNumberOfDoorHBars}  range={[0, 1, 2, 3, 4]} />
                    <LabelWithRangeForm1 label="Staanders" number={doorSpecs.numberOfVBars} setNumber={setNumberOfDoorVBars} range={[0, 1, 2, 3, 4]} />
                </div>
                {doorSpecs.leftPanel.width > 0 || doorSpecs.rightPanel.width > 0 ?
                    <div className='mt-2'>
                        <b><h5>Zig Panel</h5></b>
                        <LabelWithRangeForm1 label="Liggers" number={doorSpecs.leftRightPanelHBars} setNumber={setNumberOfLeftRightPanelHBars} range={[0, 1, 2, 3, 4]} />
                        <LabelWithRangeForm1 label="Staanders" number={doorSpecs.leftRightPanelVBars} setNumber={setNumberOfLeftRightPanelVBars} range={[0, 1, 2, 3, 4]} />
                    </div>
                    : ''}
                {doorSpecs.topPanel.include && doorSpecs.topPanel.length>0 ?
                    <div className='mt-3'>
                        <b><h5>Top Panel</h5></b>
                        <LabelWithRangeForm1 label="Liggers" number={doorSpecs.topPanel.numberOfHBars} setNumber={setNumberOfTopPanelHBars} range={[0, 1, 2, 3, 4]} />
                        <LabelWithRangeForm1 label="Staanders" number={doorSpecs.topPanel.numberOfVBars} setNumber={setNumberOfTopPanelVBars} range={[0, 1, 2, 3, 4]} />
                    </div>
                    : ''}
